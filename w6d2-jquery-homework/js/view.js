...
View.prototype.exercise5 = function () {
  ...
  $('li').on("click", event => {
    ...
    alert($currSquare.attr("data-pos"));
  });
};
...
View.prototype.exercise6 = function () {
  ...
  // $('li').addClass(window._randomColorString)
  // $('li').style("background-color: window._randomColorString")
